 ...
 */
function extractAvail(v: unknown): boolean {
...
function mapStrategyResult(r: string): string {
...
function normalizeMainBrainPayload(raw: Record<string, unknown>): Record<string, unknown> {
