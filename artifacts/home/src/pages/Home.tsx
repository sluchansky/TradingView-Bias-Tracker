...
const VOICE_BANK: Record<string, string[]> = {
  WAIT: [
    ...
    'The spread is wide and the tape is thin. Not a good time to be active.',
    'Overlapping highs and lows on the chart. Classic distribution. I stay out of this.',
    'Price is grinding sideways. No momentum. No reason. No trade.',
    'Waiting is a position. Right now it is my best one.',
    'Chasing this move would be the mistake. I will wait for the next setup.',
    'The market is testing both sides. Until one wins clearly, I am watching only.',
    'Current range is too tight to offer clean risk. Standing aside.',
    'I have seen this pattern before. It tends to resolve violently — and unpredictably. I wait.',
    'Patience is not passive. It is the most active decision I make.',
    'News flow is noisy right now. I prefer to let the market digest before committing.',
    'Three mixed signals in a row. The tape is lying to somebody. Not going to be me.',
    'Institutions are parked. Until they move, I do not move.',
    'The risk is not worth the potential return at this moment. Simple math.',
    'Watching price test the prior session high. Need to see what happens at this level.',
    'No catalyst, no structure, no direction. Three good reasons to sit tight.',
    'When in doubt, stay out. I have no doubt about sitting this one out.',
    'I would rather look back and say I missed a trade than I took a bad one.',
    'The best traders in the world spend most of their time doing exactly what I am doing — nothing.',
  ],
  ANALYZING: [
    ...
    'Volume picking up on this leg. If delta follows, we may have something here.',
    'Watching the close of this bar closely. A strong close here would change the picture.',
    'The liquidity sweep looks clean. Now I need structure to confirm it.',
    'Smart money appears to be accumulating. Score is reflecting that.',
    'Order flow is starting to tip its hand. Still building — but this is on my screen.',
    'Price is testing a level I care about. Watching how the next two bars respond.',
    'Momentum is shifting. Not committing yet, but my attention is fully here.',
    'This instrument is waking up. Score moving in the right direction — stay alert.',
    'CVD is diverging from price. That is an interesting tell. Watching carefully.',
    'Tape is beginning to show directional intent. Needs one more confirmation.',
    'The setup is early but the narrative makes sense. Following this closely.',
    'Something is loading here. I cannot act yet — but I will not look away either.',
  ],
  FORMING: [
    ...
    'This is building into something real. I need one more confirmation — stay close.',
    'Score is knocking on the door. Another clean signal and we are live.',
    'Three of four gates are green. The last one is coming — I can feel it.',
    'Narrative is strong. Structure is clean. Just waiting on the flow to agree.',
    'Bias and structure are locked in. Zone just needs to activate and hold.',
    'This is the kind of setup I have been waiting for all session. Almost there.',
    'Delta is accelerating in the right direction. Score is responding. Stay ready.',
    'The market is doing exactly what my thesis said it would. Final gate incoming.',
    'Everything is converging. Do not blink — the confirmation could come any bar.',
    'Setup integrity is high. This has the fingerprint of institutional order flow.',
    'Score is ninety percent of the way there. Final piece is zone confirmation.',
    'I do not force setups. But when they form like this one is forming — I am ready.',
    'Two bars ago I was watching. One bar ago I was interested. Right now I am alert.',
  ...
  READY_LONG: [
    ...
    'This is what all the waiting was for. Long setup is fully confirmed and live.',
    'Bullish structure, bullish delta, bullish zone. Three for three. Long is on.',
    'Patient capital gets the cleanest entries. This is a clean one. Long is ready.',
    'Edge score is at its highest point of the session. Long setup is confirmed.',
    'Institutional fingerprint all over this demand zone. Long bias is locked.',
    'Buyers absorbed every offer at that level. This is a real demand zone. Long is live.',
    'Higher highs, higher lows, vee-wap reclaimed, zone active. Nothing is missing. Long.',
    'The long side is showing everything I need — and nothing I do not. Execution ready.',
    'Risk is clearly defined. Target is realistic. Setup is clean. Long is confirmed.',
    'That was a beautiful sweep and hold into demand. Long setup is exactly what I wanted.',
    'Score is maxed. Confidence is maxed. Long is on. This is the moment I prepared for.',
    'All systems green on the long side. This is a high-conviction entry. Waiting on execution.',
    'Institutional buyers stepped in hard at that zone. The long thesis is fully validated.',
  ],
  READY_SHORT: [
    ...
    'This is what all the patience was for. Short setup is fully confirmed and ready.',
    ...
    'Lower highs, lower lows, below vee-wap, zone confirmed. The short thesis is complete.',
    'Edge score at session high on the short side. This is the setup I have been building.',
    'Price was rejected hard at supply. That is institutional supply — short is confirmed.',
    'All signals bearish and in agreement. Risk is defined. Short execution is ready.',
    'The short side is showing everything I need — and nothing I do not. On deck.',
    'Score is maxed. Direction is clear. Short is live. This is exactly what I train for.',
    'That supply zone rejection was aggressive and clean. Short setup is confirmed.',
    'Sellers absorbed every bid at that level. That is real supply. Short is on.',
    'Bearish change of character confirmed. Structure flipped. Short has full clearance.',
    'Nothing is missing on the short side. Score, structure, zone, flow — all confirmed.',
  ],
  ACTIVE: [
    ...
    'Price is respecting the move. Do not interfere. Let the edge work.',
    'We are in the trade. The process was right. Now we manage with discipline.',
    'Momentum is carrying this well. No signs of reversal in the delta.',
    'Structure is holding. Flow is cooperating. Thesis is alive and well.',
    'First half of the move complete. Watching for the next leg toward target.',
    'Stop to break even is on my mind if the next bar closes strong.',
    'Do not let a winning trade turn into a losing one. Managing actively.',
    'Price is grinding toward target. Patience in management is just as important as entry.',
    'Delta is confirming every bar. This trade is behaving exactly as modeled.',
    'Pullback happening but structure is holding. Not concerned — this was expected.',
    'The position is healthy. Trust the process. Trust the stop. Trust the target.',
    'Every tick is information. Right now, the information says hold the trade.',
    'This is where discipline matters most — while the trade is open and moving.',
  ...
  TARGET_HIT: [
    ...
    'That is how it is supposed to go. Setup, entry, target. Clean.',
    'Profit booked. Every part of this trade was done correctly. Well done.',
    'The market paid out. Now we reset and look for the next clean setup.',
    'Win confirmed. That is the compounding edge in action. Back to work.',
    ...
    'That is R in the bank. Exactly what we came here for. Outstanding.',
  ...
  STOP_HIT: [
    ...
    'That did not work. But the process was right. That is all that matters long term.',
    'Loss is accounted for. The setup was sound — the market just disagreed today.',
    'Cut cleanly. No hesitation, no averaging down. That is professional execution.',
    'Stopped out with minimal damage. Risk management worked exactly as designed.',
    'The market invalidated the thesis. That is what stops are for. Back to watching.',
    'Losses are tuition. That one taught me the market is not done with this level.',
    'Losing trade, winning process. That distinction matters more than most people know.',
    'We took a loss. Now we take a breath, reset the analysis, and look for the next edge.',
    'Not every trade wins. That is why we size correctly. Loss is contained. Moving on.',
  ],
  NO_EDGE: [
    ...
    'Below minimum threshold on everything. Not in the business of gambling today.',
    'The market is not giving me anything to work with. I respect that and stay flat.',
    'No structure. No zone. No flow. No trade. Simple.',
    'Edge is at zero. The right play is to be in zero positions.',
    'Conditions are not favorable for high-probability trading. Sitting this out.',
    'When the edge is not present, the correct response is always the same — do nothing.',
    'Nothing is close to my entry criteria right now. This is the market doing me a favor.',
