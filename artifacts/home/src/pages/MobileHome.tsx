...
const M_VOICE: Record<string, string[]> = {
  WAIT: [
    ...
    'No urgency. No pressure. Just watching until my criteria line up.',
    'If I cannot explain the setup in one sentence, I should not be taking it.',
    'Every minute I do not trade a bad setup is a minute my edge is preserved.',
    ...
    'I have been burned trying to make something out of nothing. I do not do that anymore.',
    'The market is not doing me any favors right now. That is fine. I can wait all day.',
  ],
  ANALYZING: [
    ...
    'Market is leaving clues. I am collecting them before making a call.',
    'Signals are building. The picture is becoming clearer with each bar.',
    'Not a signal yet — but this has the shape of something that is about to be one.',
    'Structure is attempting to shift. Want to see follow-through before I commit.',
    'Something is loading here. Cannot act yet, but I am not looking away either.',
  ],
  FORMING: [
    ...
    'This is the exact structure I have been waiting for since the open.',
    'Almost there. The market is doing its job — now I just have to do mine.',
    'One more gate flips green and this becomes the highest-probability trade of the session.',
    'Thesis is clean. Entry criteria is almost fully satisfied. Watching for the final trigger.',
  ],
  READY_LONG: [
  ...
  ACTIVE: [
    ...
    'I am in the trade and the market is cooperating. Do not overthink it.',
    ...
    'Structure is holding, delta is cooperating, and I am staying out of my own way.',
  ...
  TARGET_HIT: [
    ...
    'We hit target. That is what the process looks like when it all comes together.',
    'Profit booked. Setup did exactly what the edge said it would.',
    'Winner. Do not celebrate — just document it and reset for the next one.',
    'That trade made my patience worth it. Back to watching for the next setup.',
  ...
  STOP_HIT: [
    ...
    'One stop-out does not erase an edge. It is a single data point in a large sample.',
    'Loss accepted. No revenge, no doubling down. Clean slate.',
    'The thesis was wrong today. That happens. The sizing was right — that is what matters.',
  ],
  NO_EDGE: [
    ...
    'Cash is a position. Right now it is my best one.',
    'Quality edge or nothing. That is the only standard I hold myself to.',
    'Sometimes the market has nothing to offer and the right move is to accept that.',
    'I have sat out entire sessions when conditions were not right. Today might be one of those.',
